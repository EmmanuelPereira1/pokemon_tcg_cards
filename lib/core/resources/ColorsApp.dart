...
class ColorsApp {
  static Color appRedsplash = const Color(0xFFF21905);
...
class ColorsFont{
  ...
  static Color appFontWater = const Color(0xFF3692DC);
  static Color appFontFighting = const Color(0xFFE0306A);
  static Color appFontPsychic = const Color(0xFFFF6675);
  static Color appFontCorlorless = const Color(0xFF919AA2);
